...
class SuffixArray{
	private:	
		...
		void buildSuffixArray(std::vector<unsigned int> & text2Number,
			...
			merge(text2Number, sa, sa01, sa2, t01Size, t0Size, t1Size, t2Size, textSize);
		...
		void merge(std::vector<unsigned int> & text2Number,
			...
			while (k < textSize) {
				...
				if (value < t0Size) {
					...
					unsigned int t1 = getRankValue(rankVS01, value + t0Size, t01Size); 
					unsigned int t0 = getRankValue(rankVS01, sa2[i2] + 1, t01Size); 
					...
					unsigned int t1 = getRankValue(rankVS01, sa2[i2] + t0Size + 1, t01Size); 
					unsigned int t0 = getRankValue(rankVS01, value - t0Size + 1, t01Size);
